...
var ScrollReveal = function() {
    ...
    var n = {
        success: function() {
            var e = document.documentElement,
                t = document.body;
            e.classList.add("sr"), t ? t.style.height = "100%" : document.addEventListener("DOMContentLoaded", function() {
                t.style.height = "100%"
            })
        },
        failure: function() {
        ...
        for (var n = N(e), i = N(t), r = [], o = 0; o < 4; o++)
            for (var s = [n[o], n[o + 4], n[o + 8], n[o + 12]], a = 0; a < 4; a++) {
                var c = 4 * a,
                    ...
                    u = s[0] * l[0] + s[1] * l[1] + s[2] * l[2] + s[3] * l[3];
                r[o + c] = u
            }
        return r
    }
    ...
    function m(e) {
        ...
        var s, a, c, l, u, d, f, h, p, m, y, v, g, b = parseFloat(t.opacity),
    ...
    function l(e, t) {
        ...
        var n = this.store.sequences[e.sequence.id],
            i = e.sequence.index;
        if (n) {
            var r = new u(n, "visible", this.store),
                o = new u(n, "revealed", this.store);
            if (n.models = {
                visible: r,
                revealed: o
            }, !o.body.length) {
    ...
    function i(e, a, t) {
        ...
        try {
            ...
            f(i.reduce(function(e, t) {
                ...
                }(s, u, c.store.containers)) && (o = y(), u.push({
                    id: o,
                    node: s
